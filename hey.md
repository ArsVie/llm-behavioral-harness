...
- **Status:** RESOLVED (2026-08-16 01:00Z) — W1-W4 merged (33127cd), gate suite 1303/1303, G1-G5 verified all-pass, W5 deployed: old bot SIGINT'd, trial DB archived (results/live-companion/archive/companion-2026-08-15/), fresh v7 DB relaunched anchored at real local hour. Design note: docs/design-note-cognition-principle-2026-08-15.md.
