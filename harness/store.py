...
# Schema, DDL and the migration chain live in harness.store_schema.
# Re-exported so harness.store stays the single import surface.
from harness.store_schema import (  # noqa: E402,F401 - compat re-export
    SCHEMA_VERSION,
