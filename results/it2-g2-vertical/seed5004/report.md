...
title: Iteration-2 vertical slice — mock validation (seed 5004, 30 days, 5 checkpoints)
...
tags: [llm-behavioral-harness, it2, vertical-slice, mock, seed-5004]
timestamp: 2026-08-09T06:07:04.773333+00:00
---


# Iteration-2 vertical slice — mock validation (seed 5004, 30 days, 5 checkpoints)
...
| --- | --- | --- | --- |
| M1_grounded_rate | 0.913 | >= 0.9 | PASS |
| M2_invalid_source_rate | 0.087 | — | — |
| M3_recall | 1.0 | >= 0.5 | PASS |
| M4_false_recall | 0.25 | <= 0.4 | PASS |
| M5_arc_continuity | 1.0 | >= 0.9 | PASS |
| M6a_distinct_activities | 44 | — | — |
| M6b_mean_jaccard | 0.3091 | — | — |
| M6c_arc_days_mean | 22.0 | — | — |
| M6c_arc_days_min | 22 | — | — |
| M7_restart_loss | 0 | — | — |
| M8a_rho_init_tokens | 0.5105 | > 0.0 | PASS |
| M8b_token_gap | 5.69 | — | — |
| M8c_rho_energy_delay | -0.8042 | — | — |
| M9_rho_proactive_prevscore | 0.0514 | — | — |
| M10_rho_proactive_initiative | 0.3308 | — | — |
| M11_leak_hits | 0 | — | — |
...
| --- | --- | --- | --- | --- | --- | --- |
| M | 5.0 | 2.5 | -2.5 | 4.0 | 5 | None |
| initiative | 0.3738 | 0.4126 | 0.0388 | 0.1262 | 0 | 4 |
| max_tokens | 549.9 | 571.0 | 21.1 | 50.1 | 0 | 7 |
| delay | 4.6369 | 4.9205 | 0.2835 | 1.4645 | 0 | 4 |
| failures during block | 0 / 6 proactive messages |

## State observability

| Quantity | Value |
| --- | --- |
| M8a rho(initiative, max_tokens) | 0.6368 |
| M8b token gap | 19.53 |
| M8c rho(energy, delay) | -0.8298 |
| M10 rho(proactive, initiative) | 0.3476 |
| rho(M, initiative) | 0.4849 |
| rho(g, delay) | 0.4264 |
| delay sd (s) | 0.751 |
| initiative sd | 0.053 |
| arcs active/completed/abandoned | 1 / 1 / 2 |
...
| --- | --- |
| seed | 5004 |
| replay command | python -m experiments.companion_vertical_slice replay --out results/it2-g2-vertical/seed5004 |
