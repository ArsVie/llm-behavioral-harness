...
title: Iteration-2 vertical slice — mock validation (seed 5001, 120 days, 5 checkpoints)
...
timestamp: 2026-08-09T06:25:25.041101+00:00
---


# Iteration-2 vertical slice — mock validation (seed 5001, 120 days, 5 checkpoints)
...
| --- | --- | --- | --- |
| M1_grounded_rate | 0.9342 | >= 0.9 | PASS |
| M2_invalid_source_rate | 0.0658 | — | — |
| M3_recall | 0.375 | >= 0.5 | FAIL |
| M4_false_recall | 0.0 | <= 0.4 | PASS |
| M5_arc_continuity | 1.0 | >= 0.9 | PASS |
| M6a_distinct_activities | 50 | — | — |
| M6b_mean_jaccard | 0.2988 | — | — |
| M6c_arc_days_mean | 7.5 | — | — |
| M6c_arc_days_min | 4 | — | — |
| M7_restart_loss | 0 | — | — |
| M8a_rho_init_tokens | 0.2395 | > 0.0 | PASS |
| M8b_token_gap | 3.62 | — | — |
| M8c_rho_energy_delay | -0.7808 | — | — |
| M9_rho_proactive_prevscore | 0.0339 | — | — |
| M10_rho_proactive_initiative | -0.0343 | — | — |
| M11_leak_hits | 0 | — | — |
...
| job_change | 3 | [True, True, True] | YES | YES | YES |
...
| initiative | 0.3837 | 0.4047 | 0.021 | 0.1719 | 1 | 12 |
| max_tokens | 555.95 | 543.25 | -12.7 | 44.05 | 0 | 12 |
| delay | 4.6723 | 4.3464 | -0.3259 | 1.4292 | 1 | 1 |
...
| Quantity | Value |
| --- | --- |
| M8a rho(initiative, max_tokens) | 0.4002 |
| M8b token gap | 14.96 |
| M8c rho(energy, delay) | -0.7948 |
| M10 rho(proactive, initiative) | 0.2043 |
| rho(M, initiative) | 0.6632 |
| rho(g, delay) | 0.5591 |
| delay sd (s) | 0.752 |
| initiative sd | 0.077 |
...
| --- | --- |
| seed | 5001 |
| replay command | python -m experiments.companion_vertical_slice replay --out results/it2-g3-soak/seed5001 |
